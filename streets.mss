...
@fwy_z11: 2;     @hwy_z11: 1.13; @mja_z11: 0.4;  @mna_z11: 0; 
...
#tunnels[component='casing'][zoom>=13][zoom<=18] {
  ...
  [type='rail'] { line-color: lighten(@street-casing, 5%) }
  [type='path'] {
  ...
  [zoom=18] {
    ...
    [class='mainline'] {line-width: 1;}
    [class='siding'] {line-width: 1;}
...
#tunnels[component='fill'][zoom>=13][zoom<=18] {
  ...
  [zoom=16] {
    ...
    [class='stairs'] { line-width: @trl_z16 * 2.25; line-dasharray: @trl_z16,@trl_z16*0.8; }
  }
  [zoom=17] {
    ...
    [class='stairs'] { line-width: @trl_z17 * 2.25; line-dasharray: @trl_z17,@trl_z17*0.8; }
  }
  [zoom=18] {
    ...
    [class='stairs'] { line-width: @trl_z18 * 2.25; line-dasharray: @trl_z18,@trl_z18*0.8; }
  }
}
